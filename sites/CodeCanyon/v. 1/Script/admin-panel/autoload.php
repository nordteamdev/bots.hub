                    ...
                    <li <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 'amazon-settings' || $page == 'payment-settings') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'payment-settings') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo FL_LoadAdminLinkSettings('payment-settings'); ?>">Payment Settings</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'prosys-settings' || $page == 'manage-payments') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'prosys-settings') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo FL_LoadAdminLinkSettings('prosys-settings'); ?>">Pro System Settings</a>
                            </li>
                            <li <?php echo ($page == 'manage-payments') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo FL_LoadAdminLinkSettings('manage-payments'); ?>">Recent Payments</a>
                            </li>
                    ...
                    <li <?php echo ($page == 'manage-website-ads' || $page == 'manage-user-ads') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-user-ads') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo FL_LoadAdminLinkSettings('manage-user-ads'); ?>">Manage User Ads</a>
                            </li>
                        </ul>
                    </li>
