...
$final_content = FL_LoadPage('container', array(
    ...
    'FOOTER_HTML' => ($fl['page'] != 'register' && $fl['page'] != 'login' && $fl['page'] != 'forgot_password' && $fl['page'] != 'reset_password') ? FL_LoadPage('footer/content') : '',
    'AUTH_FOOTER_HTML' => ($fl['page'] == 'register' || $fl['page'] == 'login' || $fl['page'] == 'forgot_password' || $fl['page'] == 'reset_password') ? FL_LoadPage('footer/auth_footer') : '',
