...
function jBox(type, options) {
	...
	this.defaultOptions = {
		...
		'Modal': {
			...
			overlay: true,
			animation: 0,
			onOpen:function(){/* ga('html').addClass('bezovr'); */},
			onClose:function() {ga('html').removeClass('bezovr');}
		},
		...
		'Confirm': {
			...
			_onCreated: function() {
				...
				this.submitButton = jQuery('<div class="jBox-Confirm-button"/>').html(this.options.confirmButton).appendTo(this.footer);
	...
	this._create = function() {
		...
		if (this.options.closeButton) {
			...
			var closeBTNOK = '<a id="nohook_modal_close" href="javascript:;" class="ic modal-new_close_ico"></a>';
			this.closeButton.append(closeBTNOK);
