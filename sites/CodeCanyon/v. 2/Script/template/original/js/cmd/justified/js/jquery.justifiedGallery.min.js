...
! function(a) {
    ...
    b.prototype.getSuffix = function(a, b) {
		...
		for (b = 0; b < this.buildingRow.entriesBuff.length; b++){
				c = this.buildingRow.entriesBuff[b], this.settings.cssAnimation ? c.removeClass("entry-visible") : c.stop().fadeTo(0, 0);
c.closest('.media-photos').find('.feed_mm_photos').show();

//.after('<div class="fdsafioajfoia">uhfiusafisauhfsaiufhi****sdfs</div>')
