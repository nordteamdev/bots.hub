<span id="like-<?php echo $wo['like']['page_id']?>">
    <button type="button" onclick="Wo_RegisterPageLike(<?php echo $wo['like']['page_id'];?>)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       ...
       <span class="button-text"> <?php echo $wo['lang']['like'];?></span>
    </button>
</span>