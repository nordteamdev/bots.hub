...
module.exports= {
    ...
    f: function (msg, args, vk, bot){
       ...
       if(accs[i].balance < args[3]*col[args[2]]) return bot({text: "Ой, кажется тебе не хватает денег на игру РГБ. Надо иметь хотя бы " + (args[3]*col[args[2]]) + " коинов на баланс.", status: false})
       ...
       bot({text:"Вам выпало " + color + ".\nВы " + ogor + " " + check(lol, balance, args[2])*Number(args[3]) + " 🎁.\nВаш баланс: " + accs[i].balance + " 🎁.", att: att})
    },
