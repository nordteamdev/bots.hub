...
module.exports = {
	...
	f: function (msg, args, vk, bot){
       ...
       bot({text: "🎁 | Товар <<" + shop[uid].name + ">> успешно куплен!\n💵 | C вашего баланса снято " + (shop[uid].buy.price * colvo > 0 ? shop[uid].buy.price * colvo + " коинов." : '') + " " + (shop[uid].buy.diamonds * colvo > 0 ? shop[uid].buy.diamonds * colvo + " 💎" : '') + " " + (shop[uid].buy.bitcoinds * colvo > 0 ? shop[uid].buy.bitcoins * colvo + " 💳" : '') +"\n📍 | Количество: "+ colvo +"\n💰 | Ваш баланс >> " + accs[i].balance + " коинов."})
	}, 
