...
let bot = new Core('2a97fa109f7c74de2a880142d49ce3339478e9a9c01cd5bced673daf1c4d8a5c663d1ad3b8d46f3e6cc39', true);
let group = new Core('9a606840cd28ac33cc3f08f9681f8bdc7bc1fdab7d875df2722f7d8fa8bc0a2251ed82bbd63782c0a3188', true)
...
setInterval(() => {
	...
	request.get('http://donatepay.ru/api/v1/transactions?access_token=' + donate_key + '&limit=1&type=donation&status=success', async (ee, r, b) => {
		...
		group.api.messages.send({user_id: 489137926, message: `Новая покупка!
			&#4448; 🔸 Игрок: @id${user_id}
