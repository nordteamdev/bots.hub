...
vk.setOptions({ token: 'b8cf20dcb8846c55f179284e721fb3241e78ab9aeb695ae4d02322d653e26cea565cb23a1d7e10d1c4a74', pollingGroupId:185006126 });
const { updates, snippets } = vk;

updates.startPolling();
updates.on('message', async (message) => {
	if(Number(message.senderId) <= 0) return;
	if(/\[club185006126\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[club185006126\|(.*)\]/ig, '').trim();
