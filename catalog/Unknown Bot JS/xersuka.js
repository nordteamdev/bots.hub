...
🔹Что бы приобрести донат рубли, напишите создателю бота [esgoserver|Андрею Лобынцеву]
...
🔹Что бы узнать список товаров или купить донат то пишите [esgoserver|Создателю!]
`)
});
/////
