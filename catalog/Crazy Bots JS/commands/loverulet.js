...
module.exports = {
	    r: /(loverulet|cazino|lovecazino) ([0-9]+)/i,
		   ...
		   if(spot1 && spot2 && spot3){
			  if(accs[i].spots && spot && lop && lop1){
				 ...
				 bot({text: random[spot1] + " | " + random[spot2] + " | " + random[spot3] +  "\n😉 УРА! Ты выиграл: " + like(spot, 2)  + " 💵\n💰 Твой баланс: " + num(accs[i].spots.toString())  + " 💵 ", att: win})
                                 ...
                                 accs[i].spots += (spot)*4
				 bot({text: random[spot1] + " | " + random[spot2] + " | " + random[spot3] +  "\n😉 УРА! Поздравляю ✨! Ты выиграл ✨ ДЖЕКПОТ ✨! Твоя ставка увеличивается в 4 раза!!! \n💰 Твой баланс: " + num(accs[i].spots.toString())  + " 💵 ", att: win})
			  }
            }else{
		...
		desc: "loverulet <СТАВКА> -- рулетка,  испытай удачу любви сваей",
	        rights: 0,
		type: "all"
}
