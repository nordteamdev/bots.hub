...
module.exports = {
	    r: /(lotereya|supercazino|megapriz) ([0-9]+)/i,
		   ...
		   if(spot1 == spot2 == spot3){
			  if(accs[i].spots && spot && lop && lop1){
				 ...
				 bot({text: random[spot1] + " | " + random[spot2] + " | " + random[spot3] +  "\n😉 УРА! Ты выиграл: " + like(spot, 2)  + " 💵\n💰 Твой баланс: " + num(accs[i].spots.toString())  + " 💵 ", att: win})
                                 ...
                                 accs[i].spots += (spot)*7777777
				 bot({text: random[spot1] + " | " + random[spot2] + " | " + random[spot3] +  "\n😉 УРА! Поздравляю ✨! Ты выиграл ✨ ДЖЕКПОТ ✨! Твоя ставка увеличивается в 7777777 раз!!! \n💰 Твой баланс: " + num(accs[i].spots.toString())  + " 💵 ", att: win})
			  }
            }else{
		...
		desc: "lotereya <СТАВКА> -- рулетка, в которой есть шанс выбить джепот X7777777 для избранных, но шанс очень мал вам придется постараться",
	        rights: 1,
		type: "all"
}
