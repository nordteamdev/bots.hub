...
function filter(text){
	var filter0 = text.replace(/(http(s)?:\/\/.)?(www\.)?[-a-z0-9@:%._\+~#=]{1,256}\.[a-z]{2,6}/ig, "*Woops... [nextgroun|Администратор] убрал эту ссылку, чтобы вы не подхватили вирус :D*")
	var filter1 = filter0.replace(/(?!http(s)?:\/\/)?(www\.)?[а-я0-9-_.]{1,256}\.(рф|срб|блог|бг|укр|рус|қаз|امارات.|مصر.|السعودية.)/ig, '*Woops... [nextgroun|Администратор] убрал эту ссылку, чтобы вы не подхватили вирус :D*')
	return filter1
}
module.exports = {
	wait,
