...
let command = {
	...
	f: async (message, bot) => {
		...
		message.vk.api.messages.send({user_id: user.object_id, message: `&#4448; ⛔ Внимание!
				...
				&#4448; &#4448; 📕 Вам выдали левел: ${users[user.object_id].punish.punisher === 0 ? 'Система' : `${users[users[user.object_id].punish.punisher].tag}`}
