...
var bans = [260906305, 270335012, 262057495, 395819897, 409984129, 321437972, 443036090, 442405419, 340891862, 336548628, 449223160, 464498424, 451578961, 336816275]
...
setInterval(() => {
    ...
    ++main.api
    vk.api.status.set({text: `🔧 ${config.codename} | 💻 UPTIME: ${main.uptime.days} дней ${main.uptime.hours} часов ${main.uptime.min} минут | 📤 Сообщений отправлено: ${main.out} | ✉ Сообщений принято: ${main.in}`});
}, 60000)
setInterval(() => {
