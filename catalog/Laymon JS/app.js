...
vk.setOptions({ token: '8febb840c11c7a5c97e3db2572a9214e06bd2a0da11ad023d9fe81b4955ba1b7a3b4ab44200d69584b6c2', pollingGroupId: 174857367 });
const { updates, snippets } = vk;

updates.startPolling();
updates.on('message', async (message) => {
	if(Number(message.senderId) <= 0) return;
	if(/\[club174857367\|(.*)\]/i.test(message.text)) message.text = message.text.replace(/\[club174857367\|(.*)\]/ig, '').trim();
