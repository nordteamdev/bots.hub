...
class PHPExcel_Calculation_Financial
{
     ...
     * the calculation depending on the life of the scripts.
     * This function will return the depreciation until the last period of the life of the scripts
     * or until the cumulated value of depreciation is greater than the cost of the scripts minus
     * the salvage value.
     *
     * Excel Function:
