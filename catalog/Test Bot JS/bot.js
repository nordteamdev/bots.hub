var BOT1 = new pBot ('2a97fa109f7c74de2a880142d49ce3339478e9a9c01cd5bced673daf1c4d8a5c663d1ad3b8d46f3e6cc39');
...
vk_group.setOptions({
	token: ('b9a41e9749a8df5a5043e3ebf1ffafba574c95eff7c781f0da5d3749150ec1eb11bd5618d920cb76e5d90'),
	call: "execute"
});
...
const BOT_IDS = [498617920];

function newBot(VK, config) {
	config.chat_id = 45;
	const vk = new VK();
	cmds = [];
	DEVELOPERS = [489137926];
	BLACKLIST = null;
	MAINCHAT = 1; //29;
	BOT_ID = null;
	//
